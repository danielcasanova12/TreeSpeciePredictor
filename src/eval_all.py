...
# Base paths
SRC_DIR = Path("/home/agrilab/Documentos/Casanova/Arvores/Dataset/src")
DATA_DIR = Path("/home/agrilab/Documentos/Casanova/Arvores/Dataset/dados")
...
def build_model_list():
    ...
    for version in MODEL_VERSIONS:
        for dataset in DATASETS:
            model_path = SRC_DIR / version / dataset / "weights" / "best.pt"
...
def create_summary(results):
    ...
    for model_info in results:
        ...
        version = model_info["version"]
        name = model_info["name"]
        metrics_file = BASE_OUTPUT_DIR / version / name / "metrics.json"
...
def main():
    ...
    evaluate_py = Path(__file__).parent / "evaluate.py"
